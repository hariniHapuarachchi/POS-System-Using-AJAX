...
export class ItemDAOImpl implements ItemDAO {
    ...
    delete(code: string): Promise<boolean> {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.connection.query(`DELETE FROM Item WHERE itemCode='${code}'`,
                (err, results) => {
    ...
    find(code: string): Promise<Array<Item>> {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.connection.query(`SELECT * FROM Item WHERE itemCode='${code}'`,
                (err, results) => {
    ...
    save(entity: Item): Promise<boolean> {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.connection.query(
                `INSERT INTO Item VALUES ('${entity.code}','${entity.description}','${entity.unitPrice}','${entity.qtyOnHand}')`,
                (err, results) => {
