...
var ItemDAOImpl = /** @class */ (function () {
    ...
    ItemDAOImpl.prototype.delete = function (code) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.connection.query("DELETE FROM Item WHERE itemCode='" + code + "'", function (err, results) {
                if (err) {
                    reject(err);
                }
                else {
    ...
    ItemDAOImpl.prototype.find = function (code) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.connection.query("SELECT * FROM Item WHERE itemCode='" + code + "'", function (err, results) {
                if (err) {
                    reject(err);
                }
                else {
